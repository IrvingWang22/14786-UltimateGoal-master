...
@Config
@Autonomous(name = "CaramelAutonB2")
public class CaramelAutonB2 extends LinearOpMode {
    ...
    public static double QUAD_RING_Y = 55;

    public static double SINGLE_RING_X = 30;
    public static double SINGLE_RING_Y = 20;

    public static double NO_RING_X = 0;
    public static double NO_RING_Y = 55;

    public static double STRAFE_RIGHT_TO_RING = 13;
    public static double INTAKE_BACK = 35;
    public static double WOBBLE_TURN = -90;
...
//                        telemetry.addData("# Object Detected", updatedRecognitions.size());
                        ...
                        Trajectory getNewRings = drive.trajectoryBuilder(goToShootOne.end())
                                .strafeRight(STRAFE_RIGHT_TO_RING)
                                .addDisplacementMarker(() -> {
