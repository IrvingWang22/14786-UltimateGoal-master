...
public class NextTeleOp extends LinearOpMode {
    ...
    public void runControls() {
        ...
        if (gamepad2.a) mech.wobbleControl(Mechanisms.wobblePos.CLOSE);
        ...
        if (gamepad2.right_bumper) mech.setShooter(Mechanisms.motorPower.MED);
    ...
    public void runDrive() {
        ...
        drive.setWeightedDrivePower(
                new Pose2d(
                        Range.clip(-gamepad1.left_stick_y, -0.85, 0.85),
                        Range.clip(-gamepad1.left_stick_x, -0.85, 0.85),
                        Range.clip(-gamepad1.right_stick_x, -0.85, 0.85)
                )
        );
